<script lang="ts">
  ...
  import AttachmentIcon from './attachment-icon.svelte'
  ...
  import { getMiddlewareTransformers, slashSnippets } from '../(data)/data'
  ...
  const ext: Plugin = {
    ...
    transformers: getMiddlewareTransformers($appInfo.attachmentCDN)
  }
